...
| `bangumi.get_collection_backlog`      | read:collection | read     | 当前账号动画 backlog、正篇 sourceTotal、airdate 完结状态、剩余集数与冲突/无法计算状态 |
...
rendering comments; it uses episode sourceTotal as the denominator and exposes
airdate completion as finished/ongoing/unknown evidence.
