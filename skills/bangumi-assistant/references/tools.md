...
Renderer companions include `bangumi.render_series_watch_order`; it accepts the
same bounded `subjectId`, `depth` (0-2), `maxNodes` (1-16), and `media`
...
visible rather than presenting a unique official order.
