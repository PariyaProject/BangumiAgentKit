...
- [x] 每个工具有测试源码引用：96/96。
- [ ] 每个工具都有直接 `execute` 夹具：48/96；仍有 48 项待补。
...
| `bangumi.get_subject_identity` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
...
| `bangumi.get_subject_stats` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_stats_history` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_stats_intelligence` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
