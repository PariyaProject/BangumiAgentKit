...
- [x] 每个工具有测试源码引用：96/96。
- [ ] 每个工具都有直接 `execute` 夹具：36/96；仍有 60 项待补。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `bangumi.aggregate_subject_cohort` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.auth_disconnect` | `required` | `destructive` | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ | 补直接夹具；准备账号验收；评估是否进入 QQ |
| `bangumi.auth_list_accounts` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.auth_remove_account` | `required` | `destructive` | ✅ | ✅ | ✅ | ⬜ | ⬜ | ⬜ | 准备账号验收；评估是否进入 QQ |
| `bangumi.auth_start` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.auth_status` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.auth_switch_account` | `none` | `write` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.call_operation` | `optional` | `read` | ✅ | ✅ | ✅ | ⬜ | ⬜ | ⬜ | 准备账号验收；评估是否进入 QQ |
| `bangumi.compare_subject_cohorts` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.describe_operation` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_calendar` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_calendar_intelligence` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_character` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_character_collection` | `optional` | `read` | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ | 补直接夹具；准备账号验收；评估是否进入 QQ |
| `bangumi.get_character_credit_integrity` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_collection` | `optional` | `read` | ✅ | ✅ | ✅ | ⬜ | ⬜ | ⬜ | 准备账号验收；评估是否进入 QQ |
| `bangumi.get_collection_backlog` | `required` | `read` | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ | 补直接夹具；准备账号验收；评估是否进入 QQ |
| `bangumi.get_collection_dashboard` | `required` | `read` | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ | 补直接夹具；准备账号验收；评估是否进入 QQ |
| `bangumi.get_collection_entity_consistency` | `required` | `read` | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ | 补直接夹具；准备账号验收；评估是否进入 QQ |
| `bangumi.get_collection_intelligence` | `required` | `read` | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ | 补直接夹具；准备账号验收；评估是否进入 QQ |
| `bangumi.get_collection_schedule` | `required` | `read` | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ | 补直接夹具；准备账号验收；评估是否进入 QQ |
| `bangumi.get_collection_series_groups` | `required` | `read` | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ | 补直接夹具；准备账号验收；评估是否进入 QQ |
| `bangumi.get_episode` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
...
| `bangumi.get_episodes` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_index` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_latest_subject_revision` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_my_profile` | `required` | `read` | ✅ | ✅ | ✅ | ⬜ | ⬜ | ⬜ | 准备账号验收；评估是否进入 QQ |
| `bangumi.get_person` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_person_activity` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_person_collaboration` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_person_collection` | `optional` | `read` | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ | 补直接夹具；准备账号验收；评估是否进入 QQ |
| `bangumi.get_person_profile` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_revision` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_revision_intelligence` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_series_watch_order` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_subject` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_cast` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_comparison` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_identity` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_index_membership` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_overlap` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_overview` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_relations` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_staff` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_stats` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_stats_history` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_subject_stats_intelligence` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
| `bangumi.get_user` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
...
| `bangumi.list_person_collections` | `optional` | `read` | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ | 补直接夹具；准备账号验收；评估是否进入 QQ |
| `bangumi.list_revisions` | `none` | `read` | ✅ | ✅ | ✅ | ⬜ | — | ⬜ | 补公开 API；评估是否进入 QQ |
...
| `bangumi.query_subjects` | `none` | `read` | ✅ | ✅ | ⬜ | ◐ | — | ⬜ | 补直接夹具；评估是否进入 QQ |
...
| `bangumi.resolve_subject_concept` | `none` | `read` | ✅ | ✅ | ⬜ | ⬜ | — | ⬜ | 补直接夹具；补公开 API；评估是否进入 QQ |
