...
| S3 structured subject/community reads |          4 |                2 |         3 |          3 |         high | NEXT (gated)             |
| S6 snapshots/trend                    |          4 |                3 |         4 |          2 |            4 | high                     | NEXT     |
| S5 subject stats                      |          4 |                2 |         4 |          3 |       medium | NEXT (isolated)          |
| S3 public user activity               |          3 |                2 |         4 |          4 | high/private | LATER                    |
| S3 groups/blogs/social graph          |          3 |                2 |         4 |          5 | high/private | LATER                    |
| HTML Rakuen full-site crawl           |          3 |                1 |         5 |          5 |         high | AVOID as default         |
| community body-text summarization     |          3 |                2 |         5 |          5 |         high | AVOID until terms review |
| historical rank/demographic inference |          2 |                1 |         5 |          4 |         high | AVOID/NOT_COMPUTABLE     |

## Priority rationale

**FACT**：官方 v0 是 55 operations 的稳定 schema；S2 Calendar 当前只有 1 operation；S3 是官方 frontend private API；S5 stats/community 页面可见但 DOM/terms 风险更高；S6 需要 AgentKit 自己持续保存。
