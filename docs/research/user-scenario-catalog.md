...
| G19 | PERSON         | 这个人物最近参与的作品中，哪些是原创、哪些是改编？                     | person works、source tags/infobox、concept evidence                                       | `get_person_activity` 可在有界当前窗口读取 subject.meta_tags，并报告明确原创/未观察/未知 | 不能把未观察到原创标签解释为改编；历史、infobox/concept 证据仍缺 | `person_works` + `concept_resolve` | PersonActivity                       |
...
| T02 | 某编剧参与的作品按原创/改编分组是什么样？          | staff role、concept resolver、source/infobox evidence；`get_person_activity` 可按当前有界作品观察 subject.meta_tags |
